              ...
              <div>
                ...
                <div class="relative">
                  <input 
                    ...
                    class="w-full bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 text-sm text-center text-2xl tracking-widest"
                  />
                  <button 
