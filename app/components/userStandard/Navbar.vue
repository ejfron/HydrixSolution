...
import { Users, ChevronDown, LogOut, Menu } from '@lucide/vue'
...
<!-- Left side: hamburger (mobile only) + station dashboard title -->
<div class="flex items-center gap-3">
<button
        @click="toggleMobileSidebar"
class="md:hidden shrink-0 p-2 rounded-lg text-slate-600 hover:bg-slate-100 transition cursor-pointer"
