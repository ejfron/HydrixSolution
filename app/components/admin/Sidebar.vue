  ...
  >
    ...
    <div class="h-16 border-b border-white/10 flex items-center px-4 justify-between">
      <div class="flex items-center gap-3 min-w-0">
        ...
        <Transition name="fade">
          <div v-if="OpenSidebar" class="truncate">
            <p class="text-gray-100 text-xl font-black">Hydrix</p>
      ...
      >
        ...
        <PanelLeftOpen v-else class="w-5 h-5 text-gray-100" />
      </button>
    </div>
    ...
    <div class="border-t border-white/10 p-3">
      <button
        @click="handleLogout"
        :class="[
          OpenSidebar ? 'px-3 gap-3' : 'justify-center',
          'w-full h-11 rounded-xl flex items-center text-gray-100 cursor-pointer hover:bg-red-500/10 hover:text-red-400 transition'
        ]"
      >
