...
import PasscodeReset from '~/components/userBasic/PasscodeReset.vue'
import DeleteConfirmModal from '~/components/userBasic/DeleteConfirmModal.vue'
import PayTypePerGallon from '~/components/userBasic/workers/PayTypePerGallon.vue'
import PayTypeFixedPlusPercent from '~/components/userBasic/workers/PayTypeFixedPlusPercent.vue'
import PayTypeFixed from '~/components/userBasic/workers/Paytypefixed.vue'
