...
import ChooseEdit from '~/components/userStandard/ChooseEdit.vue'
import EditTransactionModal from '~/components/userStandard/EditTransactionModal.vue'
...
const getTabPaidTotal = (tabId: string) =>
{
  ...
  return txs.reduce((s, t) => s + Number(t.amount_paid), 0)
}
