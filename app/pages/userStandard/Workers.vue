...
import PasscodeSetup from '~/components/userStandard/PasscodeSetup.vue'
import PasscodeVerify from '~/components/userStandard/PasscodeVerify.vue'
import PasscodeReset from '~/components/userStandard/PasscodeReset.vue'
import DeleteConfirmModal from '~/components/userStandard/DeleteConfirmModal.vue'
import PayTypePerGallon from '~/components/userStandard/workers/PayTypePerGallon.vue'
import PayTypeFixedPlusPercent from '~/components/userStandard/workers/PayTypeFixedPlusPercent.vue'
import PayTypeFixed from '~/components/userStandard/workers/Paytypefixed.vue'
